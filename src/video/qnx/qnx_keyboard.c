...
static int key_to_sdl[] = {
    ...
    [KEYCODE_CAPS_LOCK] = SDL_SCANCODE_ESCAPE,
    ...
    */
    ...
    [KEYCODE_DISPLAY_BRIGHTNESS_DECREMENT] = SDL_SCANCODE_BRIGHTNESSDOWN,
    [KEYCODE_DISPLAY_BRIGHTNESS_INCREMENT] = SDL_SCANCODE_BRIGHTNESSUP,
    [KEYCODE_ILLUMINATION] = SDL_SCANCODE_KBDILLUMTOGGLE,
