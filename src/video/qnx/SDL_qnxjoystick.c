...
static bool QNX_JoystickOpen(SDL_Joystick * joystick, int device_index){
	...
	if(data->attached != NULL) return false;
...
static bool QNX_JoystickRumble(SDL_Joystick *joystick, Uint16 low_frequency_rumble, Uint16 high_frequency_rumble) {
    return SDL_Unsupported();
}

static bool QNX_JoystickRumbleTriggers(SDL_Joystick *joystick, Uint16 left_rumble, Uint16 right_rumble) {
    return SDL_Unsupported();
}
